...
trait HttpRequest
{
     ...
     * @param int $isPost
     */
    private function setCurlUrlMethod($handle, $url, $params, $isPost = 0)
    {
        if ($isPost === 1) {
     ...
     * @return array
     */
    protected function getByQueue(array $urls = [], array $params = [], array $option = [])
    {
        $mh = \curl_multi_init();
        $responses = [];
     ...
     * @return array
     */
    protected function postByQueue(array $urls = [], array $params = [], array $option = [])
    {
        $mh = \curl_multi_init();
        $responses = [];
        foreach ($urls as $key => $url) {
